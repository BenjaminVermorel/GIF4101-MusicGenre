...
def LDAOptimalParameters(X,y, groupValues = False):
    print("     Calcul des paramètres optimaux de LinearDiscriminantAnalysis")
    X_train, X_test, y_train, y_test = train_test_customSplit(X, y, groupValues)
...
def NearestCentroidOptimalParameters(X,y, groupValues = False):
...
def LogisticRegressionOptimalParameters(X,y, groupValues = False):
...
def PerceptronOptimalParameters(X,y, groupValues = False):
...
def MLPOptimalParameters(X,y, groupValues = False):
...
def KNNOptimalParameters(X,y, groupValues = False):
...
def SVCOptimalParameters(X,y, groupValues = False):
